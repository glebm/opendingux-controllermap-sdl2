...
**NOTE:** The visual aid is similar to an XBox controller, which has A and B reversed compared to RG350/GCW0.

To skip a button that your device doesn't have, press a button that you've already bound.
